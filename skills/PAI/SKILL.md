<!--
  ...
  Built:  15 February 2026 16:44:26
-->
---
name: PAI
...
🗣️ ATOM: [Spoken summary between 12-24 words.]
```
...
- `daidentity.name` - DA's name (ATOM)
- `principal.name` - User's name (atompa)
